August 10: The idea of the project

I recently made a hexapod kit.
I really liked it, but it felt really stiff, and not smooth, so i decided to make a smooth walking quadruped myself.


My goal is to make a quadruped bot that walks by itself( not remote controlled) and can walk around obstacles. 
This will be my first project that i completely make from scratch.

I really hope that i learnmore about how arduino components work and how i can use them.
...
Really rough sketch in blender: <img width="1586" height="988" alt="image" src="https://github.com/user-attachments/assets/99743806-01cc-4c9a-8c97-21f5e152e9ce" />
...
on the hackclub guide i saw that aliexpress is cheaper so that is where i will be ordering from.
